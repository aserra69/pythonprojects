...
#compare and print
	if eval_one ** 1 == eval_one : print "%s %d" % (found_string, overall_number)

def square_eval(eval_one,eval_ten) :
#add squares
	squares = eval_one ** 2 + eval_ten ** 2
#eval to overall number and print
	if squares == overall_number : print "%s %d" % (found_string, overall_number)
...
#eval to overall number and print
	if cubes == overall_number : print "%s %d" % (found_string, overall_number)
	
def quad_eval(eval_one,eval_ten,eval_hundred,eval_thousand):
#add quads
	quads = eval_one ** 4 + eval_ten ** 4 + eval_hundred ** 4 + eval_thousand ** 4
#eval to overall number and print
	if quads == overall_number : print "%s %d" % (found_string, overall_number)
...
#eval to overall number and print
	if pents == overall_number : print "%s %d" % (found_string, overall_number)
...
print "%s %d" % (final_string, overall_number)
